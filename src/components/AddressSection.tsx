...
export function AddressSection() {
  return <AnimatedSection className="py-20 px-6 md:px-12 lg:px-20 max-w-[1400px] mx-auto block bg-[#2d4a4a]" animation="fade-in-up">
      <div className="flex flex-col md:flex-row gap-12 lg:gap-20">
        {/* Left Column: Visual/Map Representation */}
        <div className="w-full md:w-1/2 relative min-h-[400px]">
          {/* Decorative border frame */}
          <div className="absolute inset-0 border border-white/30 translate-x-4 translate-y-4 hidden md:block" />
          ...
          <div className="relative h-full w-full bg-[#2d5555]/20 border border-white/10 overflow-hidden group">
            ...
            {/* Overlay Label */}
            <div className="absolute bottom-0 left-0 bg-[#1a3a3a]/95 px-6 py-4 border-t border-r border-white/10">
              <span className="text-xs tracking-widest uppercase flex items-center gap-2 text-white">
                <MapPin size={14} />
                Main Campus
              </span>
            </div>
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center">
          <div className="mb-10">
            <span className="text-xs tracking-[0.2em] uppercase text-white/70 font-bold mb-4 block">
              Visit Us
            </span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-10">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3 opacity-80 hover:opacity-100 transition-opacity">
                ...
                <div className="text-sm font-light tracking-wide">
                  ...
                  <p className="text-white/70">074 343 1488</p>
                  <p className="text-white/70">@apple_tree_tots_preschool</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 opacity-80 hover:opacity-100 transition-opacity">
                <Clock className="w-5 h-5 mt-1 shrink-0 text-white" />
                <div className="text-sm font-light tracking-wide">
                  <p className="uppercase tracking-widest font-medium mb-1 text-white">
                    School Hours
                  </p>
              ...
              <div className="flex items-start gap-3 opacity-80 hover:opacity-100 transition-opacity">
                <Calendar className="w-5 h-5 mt-1 shrink-0 text-white" />
                <div className="text-sm font-light tracking-wide">
                  <p className="uppercase tracking-widest font-medium mb-1 text-white">
                    Campus Tours
                  </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button className="w-full sm:w-auto bg-white text-[#2d4a4a] hover:bg-white/90 border-0">
              Schedule a Tour
            </Button>
            <Button className="w-full sm:w-auto border border-white text-white hover:bg-white hover:text-[#2d4a4a]">
              Get Directions
            </Button>
          </div>
        </div>
