      ...
      <div className="hidden md:grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="group">
          <div className="aspect-square overflow-hidden rounded-lg mb-6">
            <img src="/apple-tree-tots/images/apple-tree-tots-images/play.png" alt="Children learning through play and interaction" className="w-full h-full object-cover group-hover:scale-105 transition-all duration-700" />
          </div>
        ...
        <div className="group">
          <div className="aspect-square overflow-hidden rounded-lg mb-6">
            <img src="/apple-tree-tots/images/apple-tree-tots-images/creative.png" alt="Colorful creative art and handprints" className="w-full h-full object-cover group-hover:scale-105 transition-all duration-700" />
          </div>
          <h3 className="text-lg font-semibold text-[#2A372F] mb-3">
            Creative Spaces
          </h3>
        ...
        <div className="group">
          <div className="aspect-square overflow-hidden rounded-lg mb-6">
            <img src="/apple-tree-tots/images/apple-tree-tots-images/teaching.png" alt="Caring teacher with happy children" className="w-full h-full object-cover group-hover:scale-105 transition-all duration-700" />
          </div>
          <h3 className="text-lg font-semibold text-[#2A372F] mb-3">
